...
void makeOneDatacardTop(TString inputname, TString category, TString wpmin, TString wpmax, TString name_, TString sample, TString era) {
  ...
  std::cout << "bin             pass pass pass pass    fail fail fail fail fail \n";
  std::cout << "process         tp3  tp2  tp1 other     tp3  tp2  tp1 other qcd  \n";  
  std::cout << "process         4 3 6 -7      4 3 6 -7 8  \n";
  std::cout << "rate            -1 -1 -1 -1     -1 -1 -1 -1 -1  \n"; 
  std::cout << "------------\n";


  std::cout << "lumi            lnN      1.023 1.023 1.023 1.023     1.023 1.023 1.023 1.023 1.023 \n";
  std::cout << "\n";
  ...
  std::cout << "otherJMS         shape    - - - 1     - - - 1 1 \n";

  std::cout << "tp3JMR         shape    1 - - -     1 - - - - \n";
  std::cout << "tp2JMR         shape    - 1 - -     - 1 - - - \n";
  std::cout << "tp1JMR         shape    - - 1 -     - - 1 - - \n";
  std::cout << "otherJMR         shape    - - - 1     - - - 1 1 \n";

  std::cout << "L1PreFiringWeight         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "TptReweight         shape    1 1 1 -     1 1 1 - - \n";
  std::cout << "Pdfweight         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "Pileup         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "JES         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "JER         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "UE         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "ISRunc_qcd         shape    1 1 1 -     1 1 1 - 1 \n";
  std::cout << "FSRunc_qcd         shape    1 1 1 -     1 1 1 - 1 \n";
  std::cout << "ISRunc_ewk         shape    1 1 1 1     1 1 1 1 - \n";
  std::cout << "FSRunc_ewk         shape    1 1 1 1     1 1 1 1 - \n";
  std::cout << "QCDscale_uncert_qcd         shape    1 1 1 -     1 1 1 - 1 \n";
  std::cout << "QCDscale_uncert_ewk         shape    1 1 1 1     1 1 1 1 - \n";
  std::cout << "MuonIDWeight_uncert_stat         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "MuonIDWeight_uncert_syst         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "MuonRecoWeight_uncert_stat         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "MuonRecoWeight_uncert_syst         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "MuoTrigSF_lowPt         shape    1 1 1 1     1 1 1 1 1 \n";
  std::cout << "MuoTrigSF_highPt         shape    1 1 1 1     1 1 1 1 1 \n";
